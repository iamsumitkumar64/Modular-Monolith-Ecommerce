...
import { CART_USER_REPOSITORY, CART_INBOX_REPOSITORY } from 'src/common/infrastruture/rabbit-mq/rabbit-mq.module';
...
export class UserRegisteredConsumer implements OnModuleInit {
    ...
    constructor(
        ...
        @Inject(CART_USER_REPOSITORY) private readonly userRepo: UserRepository,
        @Inject(CART_INBOX_REPOSITORY) private readonly inboxRepo: InboxRepository,
    ) { }
